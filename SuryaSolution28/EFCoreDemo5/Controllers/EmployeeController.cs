...
namespace EFCoreDemo5.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EName,Gender,Age")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EName,Gender,Age")] EmployeeModel employeeModel)
        {
