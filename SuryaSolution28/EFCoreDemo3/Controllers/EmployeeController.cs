...
namespace EFCoreDemo3.Controllers
{
    public class EmployeeController : Controller
    {
        private readonly EFCoreDemo3Context _context;

        public EmployeeController(EFCoreDemo3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,EName,Job,Salary")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EName,Job,Salary")] EmployeeModel employeeModel)
        {
